...
export const videoJobs: VideoJob[] = [
  ...
  },
  {
    ...
    nextAction: "Confirm the parent checklist before moving into private upload."
  },
  {
    id: "job-mario-3",
...
export function deriveVideoPublishQueueItems(jobs: VideoJob[]): PublishQueueItem[] {
  return jobs
    .filter(
...
export function deriveVideoExceptionQueueItems(jobs: VideoJob[]): ExceptionQueueItem[] {
  return jobs
