...
} from "../shared/discover-draft-shadow-trial";

const report = runDiscoverDraftShadowTrial(undefined, new Date().toISOString());

console.log("VibeHub discover draft shadow trial");
...
console.log("");
console.log(renderDiscoverDraftShadowTrialLog(report));
